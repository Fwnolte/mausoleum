...
def start_game():
    ...
    room1 = Environment("Stone Room",
                        "A small room constructed of ancient stone and mortar. Moss grows in the cracks of the stone. It smells damp.",
                        "an ancient stone room",
                        Environment.TYPE_INTERIOR
                        [sword, rope, lever],
                        [],
                        [])
    room2 = Environment("Storage Room",
                        "An abandoned storage room. Several crates and barrels lie forgotten and rotting.",
    ...
    room3 = Environment("Forest",
                        "A quiet forest. The trees are a few feet apart, and there isn't much undergrowth.",
                        "a quiet forest",
                        Environment.TYPE_EXTERIOR,
                        [],
                        [],
                        [])

    world = World([room1, room2, room3], room1, [])
    
    # Set up room linkages
    room1.add_travel_destination("north", room2)
    room1.add_travel_destination("east", room3)
